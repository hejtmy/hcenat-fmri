...
df_mixed_contrast %>%
  mutate(pvalues = p.adjust(pvalues, method = "fdr")) %>%
...
First order statistics - e.g. modeling each person individually and then calculating average values of each beta coefficient. 
