...
```{r}
onsets_stops <- onset_stop_table.session(participant, speed_threshold = 5, min_duration = 3, 
                                         still_threshold = 1, still_duration = 2, pause_duration = 0.3)
